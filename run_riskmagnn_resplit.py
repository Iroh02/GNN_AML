...
def main():
    ...
    df.to_csv('results/riskmagnn_resplit_results.csv', index=False)
    print("\nResults saved to results/riskmagnn_resplit_results.csv")

    # Save best model
    os.makedirs('models', exist_ok=True)
    best_model = model1 if test_metrics1['pr_auc'] > test_metrics2['pr_auc'] else model2
    torch.save(best_model.state_dict(), 'models/riskmagnn_resplit.pth')
    print("Best model saved to models/riskmagnn_resplit.pth")
